  ...
  const segments =
    total > 0
      ? [
          ...
          { value: carbs, color: 'var(--chalk)', label: 'Carbs' },
          { value: fat, color: 'var(--clay)', label: 'Fat' },
        ]
      : [];
  ...
  return (
    <div className="donut-wrap">
      ...
      <ul className="legend">
        ...
        <li>
          <span className="swatch" style={{ background: 'var(--chalk)' }} /> Carbs
          <strong>{carbs}%</strong>
        </li>
        <li>
          <span className="swatch" style={{ background: 'var(--clay)' }} /> Fat
          <strong>{fat}%</strong>
        </li>
      </ul>
    </div>
